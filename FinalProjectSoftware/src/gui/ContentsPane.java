...
public class ContentsPane extends JPanel implements Observer{
	/**
	 * 
	 */
	private static final long serialVersionUID = 3287371591775201254L;
...
//		graphSemanticslLabel.setFont(font.deriveFont(attributes));
		...
		getResetGraphButton().setBounds(365, 60, 150, 30);
		getResetGraphButton().setMargin(new Insets(0, 0, 0, 0));
		getResetGraphButton().setFont(buttonFont);
		getResetGraphButton().setBackground(buttonColour);
		...
		buttonsPanel.add(getResetGraphButton());
...
//		titlePanel.setPreferredSize(new Dimension(650,60));
	...
	public JButton getResetGraphButton() {
		return resetGraphButton;
	}

	public void setResetGraphButton(JButton resetGraphButton) {
		this.resetGraphButton = resetGraphButton;
	}
